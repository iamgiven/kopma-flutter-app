  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)), // Menambahkan rounded border ke Card
        child: ClipRRect( // Menggunakan ClipRRect untuk memotong gambar
          borderRadius: BorderRadius.circular(8), // Memotong gambar sesuai dengan rounded border
          child: Column(
            ...
            children: [
              Expanded(
                child: CachedNetworkImage(
                  imageUrl: item.image,
                  fit: BoxFit.cover, // Menyesuaikan gambar agar menutupi seluruh bagian
                ),
              ),
